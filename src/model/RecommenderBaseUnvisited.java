...
public class RecommenderBaseUnvisited implements Runnable {
	private SPORE sp;
...
//	private ArrayList<Pair> hitPairs;
	...
	public RecommenderBaseUnvisited(ArrayList<TestCases> joblist, int index) {
...
//		this.hitPairs = new ArrayList<Pair>();
	...
	public void run() {
		...
		for (TestCases query : joblist) {
			...
			ArrayList<Integer> unratedItems = sp.unvisitedItems.get(uq);
